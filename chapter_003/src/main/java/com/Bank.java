...
public class Bank {
	// Класс Account в данном пакете определен, в то время как класс User нет
	...
	//у нас не определен метод для добавления нового аккаунта юзеру, т.е. в данном классе у юзера он может быть только 1,
	// поэтому данный метод не имеет смысла (выше и так есть метод getActualAccount)
